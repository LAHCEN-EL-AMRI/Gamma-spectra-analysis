...
public class Mainn extends JFrame {
	...
	public Mainn() {
        ...
        btnfile.addActionListener(new ActionListener() {
		    ...
		    File ff=new File(fichier1); // définir l'arborescence
		   	try {
      ...
      //----------------------------------------------------------
		...
		//-------en cas le fichier entré n'a pas les infos de calibration
		...
		TextField textField1tpe = new TextField("a");
		TextField textField2tpe = new TextField("b");
		TextField textField3tpe = new TextField("c");
		TextField textField4tpe = new TextField("d");
		TextField textField5tpe = new TextField("e");
		TextField textField6tpe = new TextField("f");
		
		JMenuItem mntmEfficiencyCalibration = new JMenuItem("Efficiency calibration");
		mntmEfficiencyCalibration.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				...
				else{mntmEfficiencyCalibration.setEnabled(false);}//Pour apparaitre "Efficiency calibration" doit changer false par true
			}
		});
		...
		mntmEfficiencyCalibration.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				btnOktpe.setBounds(100, 190, 70, 23);
				...
				btnOk1tpe.setBounds(200, 190, 100, 23);
		...
		mnCalibration.add(mntmEfficiencyCalibration);
		
		JMenu mnT = new JMenu("Analyser  ");
		menuBar.add(mnT);
		...
		mntmPeakSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				 ...
				 // peakPosition="marker";    //pour apparaitre Marker sur graph
				  evitErrRaprt="apparaitre";//pour éviter erreur en rapport des resultats
		...
		mntmLogEchel_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {				
			      ...
			      evitErrRaprt="apparaitre";//pou éviter erreur en rapport des resultats
		...
		JMenuItem mntmIdentification = new JMenuItem("Identification");
				...
				bntEdit.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {	
						...
						for(int jS=0;jS<size;jS++) {
		    			  ...
		    			  collect=collect+linResult+"      "+nceid+lin;
						}
						textArea.setText("");
						String eps= "                                   ";
						String Names = "             Channel"+eps+"Energy"+eps+"FWHM"+eps+"Net area                          Background                          Error (%)";
						textArea.setText(Names+"        "+"nucleids"+lin+lin+collect);
			    ...
			    String stta1 = null;
			   	try {
			   		if(forRaport=="logTreatmnt") {
			   		 stta1 =treatmentLog.resultsfile;
			   		}
			   		if(forRaport=="Treatmnt") {
				   		 stta1 =treatment1.resultsfile;
				   		}
					ff.createNewFile();
					FileWriter ffw = new FileWriter(ff);
				   	String mot00 ="Operator                      : "+Edit1;
		...
		JMenu mnGraphView = new JMenu("Graphic view");
        		...
        		if(fichier==null){JOptionPane.showMessageDialog(null, "enter spectrum file ");}
                    ...
                    if(analyse=="g2") {
						...
						if(Mainn.mntmPeakSearch.isSelected()) {
				            ...
				            zomRangPeak   =		Float.parseFloat(PeakSearch.energyPic.get(clik));  //energie correspend à centroide de pic
					...
					if(analyse=="g3") {
			            ...
			            zomRangPeak   =		Float.parseFloat(treatmentLog.RangAxisPeakCmpr.get(clik));  //air correspend à centroide de pic
					...
					if(analyse=="g") {
			            ...
			            zomRangPeak   =		Float.parseFloat(treatment1.RangAxisPeak.get(clik));  //air correspend à centroide de pic
